<template>
  <div class="relative">
    <flat-pickr class="form-input pl-9 dark:bg-gray-800 text-gray-600 hover:text-gray-800 dark:text-white dark:hover:text-gray-100 font-medium w-[15.5rem]" :config="config" v-model="date"></flat-pickr>
