<template>
  <div>
    <button
      ref="trigger"
      class="rounded-full"
      :class="dropdownOpen ? 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-white' : 'bg-white dark:bg-gray-700 text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300'"      
      aria-haspopup="true"
