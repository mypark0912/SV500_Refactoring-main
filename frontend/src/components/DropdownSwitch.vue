<template>
  <div class="relative">
    ...
    >
      ...
      <div class="truncate">
        <span class="text-sm font-medium dark:text-white group-hover:text-gray-800 dark:group-hover:text-gray-200">Acme Inc.</span>
      </div>
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full left-0 min-w-60 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1">
        ...
        >
          <li>
            <a class="font-medium text-sm text-gray-600 dark:text-white hover:text-gray-800 dark:hover:text-gray-200 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
