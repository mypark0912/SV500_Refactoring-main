  ...
  <div class="relative inline-flex">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full min-w-44 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
        ...
        >
          <li>
            <a class="font-medium text-sm text-gray-600 dark:text-white hover:text-gray-800 dark:hover:text-gray-200 flex items-center py-1 px-3" href="#0" @click="dropdownOpen = false">Business Account</a>
          </li>
          <li>
            <a class="font-medium text-sm text-gray-600 dark:text-white hover:text-gray-800 dark:hover:text-gray-200 flex items-center py-1 px-3" href="#0" @click="dropdownOpen = false">Family Account</a>
          </li>
        </ul>
      </div> 
    </transition>
