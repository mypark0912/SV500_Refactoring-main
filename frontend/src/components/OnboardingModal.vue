        ...
        <div class="p-6">
          ...
          >
            ...
            <div v-else class="space-y-4">
              ...
              >
                <h3
                  class="font-semibold mb-3 text-red-700 dark:text-red-400 flex items-center"
                >
                  <svg
                    class="w-5 h-5 mr-2"
                    fill="currentColor"
              ...
              >
                <h3
                  class="font-semibold mb-3 text-yellow-700 dark:text-yellow-400 flex items-center"
                >
                  <svg
                    class="w-5 h-5 mr-2"
                    fill="currentColor"
              ...
              >
                <div class="flex items-center">
                  ...
                  <span class="text-green-700 dark:text-green-400 font-medium"
                    >All settings validation passed successfully</span
                  >
                </div>
              </div>
              ...
              >
                <div class="flex items-center">
                  ...
                  <span class="text-yellow-700 dark:text-yellow-400 font-medium"
                    >Settings validation completed with warnings. You can
                    proceed but please review the warnings above.</span
                  >
                </div>
              </div>
            </div>
          ...
          <div v-show="currentStep === 4" class="step-content">
            ...
            <div v-if="OpMode === 'device0'" class="space-y-4">
              <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                ...
                <div class="space-y-2 text-sm">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    >
                    <span>{{
                      validationTimestamp || new Date().toLocaleString()
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between">
                    <span class="text-gray-600 dark:text-gray-400"
              ...
              >
                ...
                <ul class="space-y-1 text-sm">
                  ...
                  >
                    <svg
                      class="w-4 h-4 shrink-0 fill-current text-red-500 mr-2 mt-0.5"
                      viewBox="0 0 12 12"
                    >
                      <path
                        d="M11.707 1.293a1 1 0 0 0-1.414 0L6 5.586 1.707 1.293a1 1 0 0 0-1.414 1.414L4.586 7 .293 11.293a1 1 0 0 0 1.414 1.414L6 8.414l4.293 4.293a1 1 0 0 0 1.414-1.414L7.414 7l4.293-4.293a1 1 0 0 0 0-1.414z"
                      />
                    </svg>
                    <span>{{ error }}</span>
                  </li>
                  ...
                  >
                    <svg
                      class="w-4 h-4 shrink-0 fill-current text-yellow-500 mr-2 mt-0.5"
                      viewBox="0 0 12 12"
                    >
                      <path
                        d="M6 0C2.686 0 0 2.686 0 6s2.686 6 6 6 6-2.686 6-6-2.686-6-6-6zm0 10c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm1-3H5V3h2v4z"
                      />
                    </svg>
                    <span>{{ warning }}</span>
                  </li>
            ...
            <div v-else class="space-y-4">
              ...
              <div class="text-xs text-gray-500">
                By completing this setup, you confirm that all diagnosis tests
