...
const thdTreeData_normal = {
  ...
  children: [
    ...
    { ID: 35, Name: "THD_V", Title: "THD Phase Voltage (Avg)", Titles: { en: "THD Voltage (Avg)", ko: "THD 상전압 (평균)", ja: "THD 相電圧 (平均)" } },
    { ID: 36, Name: "THD_Upp1", Title: "THD Voltage L12", Titles: { en: "THD Voltage L12", ko: "THD 전압 L12", ja: "THD 電圧 L12" } },
    { ID: 37, Name: "THD_Upp2", Title: "THD Voltage L23", Titles: { en: "THD Voltage L23", ko: "THD 전압 L23", ja: "THD 電圧 L23" } },
    { ID: 38, Name: "THD_Upp3", Title: "THD Voltage L31", Titles: { en: "THD Voltage L31", ko: "THD 전압 L31", ja: "THD 電圧 L31" } },
    { ID: 39, Name: "THD_Vpp", Title: "THD Line Voltage (Avg)", Titles: { en: "THD Voltage (Avg)", ko: "THD 선간전압 (평균)", ja: "THD 線間電圧 (平均)" } },
    { ID: 40, Name: "THD_I1", Title: "THD Current L1", Titles: { en: "THD Current L1", ko: "THD 전류 L1", ja: "THD 電流 L1" } },
    { ID: 41, Name: "THD_I2", Title: "THD Current L2", Titles: { en: "THD Current L2", ko: "THD 전류 L2", ja: "THD 電流 L2" } },
    { ID: 42, Name: "THD_I3", Title: "THD Current L3", Titles: { en: "THD Current L3", ko: "THD 전류 L3", ja: "THD 電流 L3" } },
    { ID: 43, Name: "THD_I", Title: "THD Current (Avg)", Titles: { en: "THD Current (Avg)", ko: "THD 전류 (평균)", ja: "THD 電流 (平균)" } },
  ],
};
...
const tddTreeData_normal = {
  ...
  isParent: true,
  children: [
    { ID: 44, Name: "TDD_I1", Title: "TDD Current L1", Titles: { en: "TDD Current L1", ko: "TDD 전류 L1", ja: "TDD 電流 L1" } },
    { ID: 45, Name: "TDD_I2", Title: "TDD Current L2", Titles: { en: "TDD Current L2", ko: "TDD 전류 L2", ja: "TDD 電流 L2" } },
    { ID: 46, Name: "TDD_I3", Title: "TDD Current L3", Titles: { en: "TDD Current L3", ko: "TDD 전류 L3", ja: "TDD 電流 L3" } },
