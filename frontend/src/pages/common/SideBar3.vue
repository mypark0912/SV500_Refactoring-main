      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <ul class="mt-3">
            ...
            <SidebarLinkGroup
              v-if="setupMenu.MainEnable"
              v-slot="parentLink"
              :activeCondition="isMainActive"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-8 mt-1" :class="!parentLink.expanded && 'hidden'">
                  ...
                  <router-link
                    to="/powerq/Main"
                    v-if="setupMenu.MainPowerQuality"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
                    <li class="mb-1 last:mb-0">
            ...
            <!-- E-Commerce  -->
            <SidebarLinkGroup
              v-if="setupMenu.SubEnable"
              v-slot="parentLink"
              :activeCondition="isSubActive"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
                  isSubActive ? '' : 'hover:text-gray-900 dark:hover:text-white'
                "
                href="#0"
                @click.prevent="
                  parentLink.handleClick();
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-8 mt-1" :class="!parentLink.expanded && 'hidden'">
                  ...
                  <router-link
                    to="/powerq/Sub"
                    v-if="setupMenu.SubPowerQuality"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
                    <li class="mb-1 last:mb-0">
            ...
            <!-- Community -->
            <SidebarLinkGroup
              v-if="setupMenu.MainDiagnosis || setupMenu.SubDiagnosis"
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('diagnosis')"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
                  currentRoute.fullPath.includes('diagnosis')
                    ? ''
                    : 'hover:text-gray-900 dark:hover:text-white'
                "
                href="#0"
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-8 mt-1" :class="!parentLink.expanded && 'hidden'">
                  <router-link
                    v-if="setupMenu.MainDiagnosis && setupMenu.MainEnable"
                    to="/diagnosis/Main"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
                  ...
                  <router-link
                    v-if="setupMenu.SubDiagnosis && setupMenu.SubEnable"
                    to="/diagnosis/Sub"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('event')"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('report')"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('trend')"
            >
              <a
                class="block text-gray-800 dark:text-gray-100 truncate transition"
                :class="
                  ...
                  >
                    <li class="mb-1 last:mb-0">
                      ...
                      >
                        <span
                          class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200"
                          >{{ t("sidebar.general") }}</span
                        >
                      </a>
                    </li>
                  </router-link>
                  <router-link
                    to="/settings/Device/Main"
                    custom
                    v-slot="{ href, navigate, isExactActive }"
                  >
                    <li class="mb-1 last:mb-0">
...
export default {
  name: "Sidebar",
  props: ["sidebarOpen", "variant", "channel"],
  components: {
    SidebarLinkGroup,
  },
  setup(props, { emit }) {
    ...
    const mainLabel = computed(() => devMode.value === 'device2' ? t('sidebar.main1') : t('sidebar.main'))
    const subLabel = computed(() => devMode.value === 'device2' ? t('sidebar.sub1') : t('sidebar.sub'))
