                  ...
                  <div class="m-3 w-24">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400 dark:bg-gray-700" for="toggle1">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
                      <div class="text-sm text-gray-400 dark:text-gray-500 italic ml-2">{{toggle1}}</div>
                    </div>
                    <!-- End -->
                  </div>
                  ...
                  <div class="m-3 w-24">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400 dark:bg-gray-700" for="toggle2">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
                      <div class="text-sm text-gray-400 dark:text-gray-500 italic ml-2">{{toggle2}}</div>
                    </div>
                    <!-- End -->
                  </div>
                  ...
                  <div class="m-3 w-32">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400 dark:bg-gray-700" for="toggle3">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
