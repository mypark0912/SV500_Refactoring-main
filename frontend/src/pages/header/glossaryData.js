...
export const equipmentData = [
  {
    ...
    items: [
      { 
        ...
        label_ko: '난류',
        label_ja: '乱流',
        description: 'Irregular flow pattern changes in gases and fluids\nCauses\nInappropriate compressor operating parameters\nPoor inlet/outlet conditions\nPoor pipe and duct design\nEffects\nReduced efficiency\nIncreased noise\nIncreased vibration\nEnergy loss',
        description_ko: '기체, 유체의 불규칙한 기류변화\n원인\n압축기 작동 매개변수 부적절\n흡입/배출 조건 불량\n배관 및 덕트 설계 불량\n영향\n효율 저하\n소음 증가\n진동 증가\n에너지 손실',
        description_ja: '気体・流体の不規則な気流変化\n原因\nファンの運転パラメータ不適切\n翼角度不適切\n吸込／吐出条件不良\n配管およびダクト設計不良\n影響\n効率低下\n騒音増加\n振動増加\nエネルギー損失',
      ...
      { 
        ...
        description_ko: '장비의 하나 이상이 베이스플레이트와 완전히 접촉하지 않아 마운팅 볼트를 조일 때 프레임이 변형되는 상태\n원인\n베이스플레이트 평탄도 불량\n장비 높이 불일치\n이물질이나 오염물 존재\n설치 시 정렬 오류\n영향\n정렬 불량\n진동 증가\n조기 베어링 고장\n프레임 변형',
      ...
      { 
        ...
        label_ko: '케이블 연결',
        label_ja: 'ケーブル接続部',
        description: 'Cable terminal connection condition\nCauses\nLoose terminals\nCorrosion, oxidation\nOverheating (discoloration)\nPhysical damage\nEffects\nHigh resistance\nVoltage drop\nLocalized heating\nArcing',
        description_ko: '케이블 단자대 체결 상태\n원인\n단자 느슨함\n부식·산화\n과열(변색)\n물리적 손상\n영향\n고저항\n전압 강하\n국부 가열\n아크 발생',
        description_ja: 'ケーブル端子台の締結状態\n原因\n端子の緩み\n腐食・酸化\n過熱（変色）\n機械的損傷\n影響\n高抵抗化\n電圧降下\n局所的な発熱\nアーク発生',
      },
      { 
        key: 'noiseVibration', 
      ...
      { 
        ...
        label_ko: '열',
        label_ja: '熱',
        description: 'Transformer temperature rise\nCauses\nIncreased harmonic stress\nAdditional losses in cables, transformers, and motors\nInsufficient cooling\nOverload\nEffects\nInsulation degradation\nReduced equipment lifespan\nThermal expansion issues\nReduced efficiency',
  ...
  },
  {
    ...
    items: [
      { 
        ...
        label_ko: '캐비테이션',
        label_ja: 'キャビテーション',
        description: 'Phenomenon where pressure at the pump inlet drops below the vapor pressure of the liquid, causing vapor bubbles to form and create shock waves in the impeller and housing, resulting in noise and vibration\nCauses\nInsufficient suction pressure\nExcessive flow rate or flow temperature\nPoor suction pipe design\nInsufficient liquid level in source tank\nHigh-speed pump operation\nEffects\nIncreased noise and vibration\nErosion of impeller blades\nReduced efficiency\nPremature pump failure',
        description_ko: '펌프 흡입구에서 압력이 액체의 증기압보다 낮아져 증기 기포가 형성되어 임펠러, 하우징에 충격파를 일으켜 소음 진동을 유발하는 현상\n원인\n흡입측 압력 부족\n유량 과다 또는 유량온도\n흡입 배관 설계 불량\n원천 탱크의 액체 레벨 부족\n펌프 고속 운전\n영향\n소음·진동 증가\n임펠러 블레이드 침식\n효율 저하\n조기 펌프 고장',
        description_ja: 'キャビテーション: ポンプ吸込口の圧力が流体の蒸気圧を下回り、蒸気泡が発生してインペラとハウジングに衝撃波を起こし、騒音・振動を引き起こす現象\n原因\n吸込側圧力不足\n過大な流量または流量温度\n吸込配管設計不良\n原水タンク液面の不足\nポンプ高速運転\n影響\n騒音・振動の増加\nインペラブレードの浸食\n効率低下\nポンプの早期故障',
      },
      { 
        key: 'vane', 
        label: 'Vane', 
        label_ko: '베인',
        label_ja: 'ベーン',
        description: 'Rotating blade inside a pump that moves fluid\nCauses\nWear, erosion, cavitation damage\nCracks\nDebris or contaminants\nManufacturing defects\nEffects\nReduced pump efficiency\nFlow imbalance\nIncreased vibration\nComplete pump failure',
        description_ko: '펌프 내부에서 유체를 이동시키는 회전 날개\n원인\n마모·침식·캐비테이션 손상\n균열\n이물질이나 오염물\n제조 결함\n영향\n펌프 효율 저하\n유량 불균형\n진동 증가\n완전한 펌프 고장',
        description_ja: 'ベーン: ポンプ内部で流体を移送する回転翼\n原因\n摩耗・浸食・キャビテーション損傷\n亀裂\n異物や汚染物質\n製造上の欠陥\n影響\nポンプ効率の低下\n流量アンバランス\n振動増加\nポンプの全損故障',
      },
      { 
        key: 'mechanicalUnbalance', 
        label: 'Mechanical Unbalance', 
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'stress', label: 'Stress', label_ko: '스트레스', label_ja: 'ストレス', description: 'Electrical, thermal, and mechanical loads repeatedly applied to equipment or components\nCauses\nOvervoltage\nOverload\nHarmonics\nTemperature rise\nEffects\nInsulation degradation\nReduced component lifespan\nIncreased failure risk\nPerformance degradation', description_ko: '설비나 부품에 반복적으로 가해지는 전기적, 열적, 기계적 부하\n원인\n과전압\n과부하\n고조파\n온도 상승\n영향\n절연 열화\n부품 수명 단축\n고장 위험 증가\n성능 저하', description_ja: 'ストレス: 設備や部品に繰り返し加わる電気的・熱的・機械的な負荷\n原因\n過電圧\n過負荷\n高調波\n温度上昇\n影響\n絶縁劣化\n部品寿命の短縮\n故障リスクの増加\n性能低下' },
      ...
      { key: 'noiseVibration', label: 'Noise/Vibration', 
        label_ko: '소음/진동', label_ja: '騒音／振動', 
        description: 'Important indicator of mechanical condition of equipment\nCauses\nBearing wear\nRotor imbalance\nIncreased harmonic stress\nMisalignment\nLoose components\nEffects\nAccelerated wear\nFatigue failure\nPotential for serious failure\nDeterioration of working environment', 
        description_ko: '설비의 기계적 상태를 나타내는 중요한 지표\n원인\n베어링 마모\n회전자 불균형\n고조파 스트레스 증가\n정렬 불량\n부품 느슨함\n영향\n마모 가속화\n피로 파괴\n심각한 고장으로 발전 가능\n작업 환경 악화', description_ja: '騒音／振動: 設備の機械的状態を表す重要な指標\n原因\nベアリング摩耗\nロータのアンバランス\n高調波ストレスの増加\nアライメント不良\n部品の緩み\n影響\n摩耗の加速\n疲労破壊\n重大故障への進展\n作業環境の悪化' },
      { key: 'heat', label: 'Heat', 
        label_ko: '열', 
        label_ja: '熱', 
        description: 'Temperature rise that occurs during equipment operation\nCauses\nIncreased harmonic stress\nAdditional losses in cables, transformers, and motors\nInsufficient cooling\nOverload\nEffects\nInsulation degradation\nReduced equipment lifespan\nThermal expansion issues\nReduced efficiency',
        description_ko: '설비 작동 중 발생하는 온도 상승\n원인\n고조파 스트레스 증가\n케이블·변압기·모터에서 추가 손실\n냉각 부족\n과부하\n영향\n절연 열화\n설비 수명 단축\n열팽창 문제\n효율 저하',
        description_ja: '熱: 設備運転中に発生する温度上昇\n原因\n高調波ストレスの増加\nケーブル・変圧器・モータでの追加損失\n冷却不足\n過負荷\n影響\n絶縁劣化\n設備寿命の短縮\n熱膨張問題\n効率低下' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'noiseVibration', 
        ...
        description: 'Important indicator of mechanical condition of equipment\nCauses\nIncreased harmonic stress\nMisalignment\nLoose components\nEffects\nFatigue failure\nPotential for serious failure\nDeterioration of working environment', 
        description_ko: '설비의 기계적 상태를 나타내는 중요한 지표\n원인\n고조파 스트레스 증가\n정렬 불량\n부품 느슨함\n영향\n피로 파괴\n심각한 고장으로 발전 가능\n작업 환경 악화', description_ja: '騒音／振動: 設備の機械的状態を表す重要な指標\n原因\n高調波ストレスの増加\nアライメント不良\n部品の緩み\n影響\n疲労破壊\n重大故障への進展\n作業環境の悪化' },
      { key: 'heat', label: 'Heat', label_ko: '열', label_ja: '熱', 
        description: 'Transformer temperature rise\nCauses\nIncreased harmonic stress\nAdditional losses in cables, transformers, and motors\nInsufficient cooling\nOverload\nEffects\nInsulation degradation\nReduced equipment lifespan\nThermal expansion issues\nReduced efficiency', 
        description_ko: '변압기 온도 상승\n원인\n고조파 스트레스 증가\n케이블·변압기·모터에서 추가 손실\n냉각 부족\n과부하\n영향\n절연 열화\n설비 수명 단축\n열팽창 문제\n효율 저하', description_ja: '熱: 変圧器の温度上昇\n原因\n高調波ストレスの増加\nケーブル・変圧器・モータでの追加損失\n冷却不足\n過負荷\n影響\n絶縁劣化\n設備寿命の短縮\n熱膨張問題\n効率低下' },
      { key: 'incomingVoltage', label: 'Incoming Voltage', label_ko: '입력 전압', label_ja: '入力電圧', description: 'Electrical potential difference supplied to equipment, a fundamental condition for normal equipment operation\nCauses\nUnstable power supply\nTransformer tap setting errors\nUnbalanced load distribution\nVoltage regulation equipment failure\nEffects\nEquipment malfunction\nOverheating\nReduced efficiency\nPremature failure', description_ko: '설비에 공급되는 전기적 전위차로, 설비의 정상 작동을 위한 기본 조건\n원인\n공급 전원 불안정\n변압기 탭 설정 오류\n부하 분산 불균형\n전압 조정 장치 고장\n영향\n설비 오작동\n과열\n효율 저하\n조기 고장', description_ja: '入力電圧: 設備に供給される電位差であり、正常運転のための基本条件\n原因\n電源の不安定\n変圧器タップ設定の誤り\n負荷分担の不均衡\n電圧調整装置の故障\n影響\n設備の誤動作\n過熱\n効率低下\n早期故障' },
    ]
  },
]
...
export const eventData = [
  { key: 'transientCurrentEvent', 
    label: 'Transient Current Event', 
    label_ko: '과도 전류 이벤트', 
    label_ja: '過渡電流イベント', 
        description: 'Momentary current surge phenomenon\nCauses\nMotor starting inrush current\nCapacitor switching\nLoad switching\nEffects\nEquipment stress\nProtective device operation\nSystem disturbances',
        description_ko: '순간적인 전류 급변 현상\n원인\n모터 기동 과도 전류\n콘덴서 스위칭\n부하 스위칭\n영향\n설비 스트레스\n보호 장치 작동\n시스템 교란', description_ja: '過渡電流イベント: 瞬間的に大きな電流が流れる現象\n原因\nモータ起動時の突入電流\nコンデンサスイッチング\n負荷スイッチング\n影響\n設備へのストレス増加\n保護装置の動作\n系統の擾乱' },
