          ...
          <div class="px-2 sm:px-4 lg:px-6 py-4 w-full max-w-full">
            ...
            <div class="sm:flex sm:justify-between sm:items-center mb-4">
              ...
              <div class="mb-4 sm:mb-0">
                <h2 class="text-lg md:text-xl text-gray-800 dark:text-gray-100 font-bold"> {{ t('diagnosis.sitemap.title') }} > {{ channel == 'Main' ? t('diagnosis.sitemap.main'):t('diagnosis.sitemap.sub') }}  </h2>
              </div>
                ...
                <div v-for="(tab, index) in tabs" :key="index">
                    <div v-if="activeTab === tab.name" class="text-gray-700 dark:text-white text-left pt-3 px-4">
                        ...
                        <div class="flex flex-col space-y-2"> 
                            ...
                            <DiagnosisTab_Chart v-else-if="activeTab === 'Fault'" :channel="channel" :asset="asset" :mode="activeTab" />
                            <DiagnosisTab_Chart v-else :channel="channel" :asset="asset" :mode="activeTab" />                    
...
import DiagnosisTab_Bands from '../../partials/modeview/diagnosis/DiagnosisTab_Bands.vue'
import { useI18n } from 'vue-i18n'  
import { useAuthStore } from '@/store/auth';
export default {
  name: 'Diagnosis_NewCSS',
  props:['channel'],
  components: {
    Sidebar,
    Header,
