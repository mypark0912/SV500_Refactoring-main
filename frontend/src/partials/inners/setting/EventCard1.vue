        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-4 mt-4">
            <div>
              ...
              <input
                v-model="inputDict.eventInfo.tv_level"
            ...
            <div>
              ...
              >
              <input
                v-model="inputDict.eventInfo.tv_holdofftime"
                class="form-input w-full"
                type="text"
                :maxlength="20"
              />
            ...
            <div>
              ...
              >
              <input
                v-model="inputDict.eventInfo.tv_fastchange"
                class="form-input w-full"
                type="text"
                :maxlength="20"
              />
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-4 mt-4">
            <div>
              <label class="block text-sm font-medium mb-2">Level (%)</label>
              <input
                v-model="inputDict.eventInfo.tc_level"
                class="form-input w-full"
                type="text"
                :maxlength="20"
              />
            ...
            <div>
              ...
              >
              <input
                v-model="inputDict.eventInfo.tc_holdofftime"
                class="form-input w-full"
                type="text"
                :maxlength="20"
              />
            ...
            <div>
              ...
              >
              <input
                v-model="inputDict.eventInfo.tc_fastchange"
                class="form-input w-full"
                type="text"
                :maxlength="20"
              />
