            ...
            <div class="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg flex flex-col flex-1">
              ...
              <div class="px-4 py-3 space-y-4">
                ...
                <div :class="inputDict.modbus.rtu_use == 0 ? 'opacity-40 pointer-events-none' : ''">
                  <div class="text-xs text-gray-800 dark:text-gray-100 font-semibold uppercase mb-2">Serial Type</div>
                  <div class="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
                    <!-- 헤더 -->
                    <div class="grid grid-cols-3 bg-blue-100 dark:bg-blue-900/40 text-center text-xs font-semibold text-gray-700 dark:text-gray-200">
                      <div class="px-2 py-2 border-r border-gray-200 dark:border-gray-600">idx</div>
                      <div class="px-2 py-2 border-r border-gray-200 dark:border-gray-600">type</div>
                      <div class="px-2 py-2">devId</div>
                    </div>
                    <!-- 행 -->
                    <div
                      v-for="item in inputDict.modbus.serialtype"
                      :key="item.id"
                      class="grid grid-cols-3 text-center text-sm border-t border-gray-200 dark:border-gray-700"
                    >
                      <div class="px-2 py-1.5 border-r border-gray-200 dark:border-gray-600 flex items-center justify-center text-gray-700 dark:text-gray-200">
                        {{ item.id }}
                      </div>
