            ...
            <div class="space-y-8 mt-8 mb-80">
              ...
              <div>
                ...
                <DropdownEditMenu class="relative inline-flex">
                  <li>
                    <a class="font-medium text-sm text-gray-600 dark:text-white hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" href="#0">Option 1</a>
                  </li>
                  <li>
                    <a class="font-medium text-sm text-gray-600 dark:text-white hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" href="#0">Option 2</a>
                  </li>
                  <li>
              ...
              <div>
                <h2 class="text-2xl text-gray-800 dark:text-gray-100 font-bold mb-6">Datepicker (built with <a class="underline hover:no-underline" href="https://github.com/flatpickr/flatpickr" target="_blank" rel="noreferrer">flatpickr</a>)</h2>
                <Datepicker />
              </div>
