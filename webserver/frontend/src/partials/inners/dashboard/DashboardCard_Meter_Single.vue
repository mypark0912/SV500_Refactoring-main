    ...
    <div class="premium-dashboard-card">
      ...
      <div class="card-header">
        <header class="header-content">
          <h2 class="card-title">{{ t('dashboard.meter.singletitle') }}</h2>
        ...
        <div class="details-grid">
          ...
          <div class="data-table">
            ...
            <div v-if="realtimeData.DashPT == 0" class="detail-values">
              ...
              <div class="value-row">
                ...
                <div class="phase-value" :class="getVoltageClass(realtimeData?.U2)">
                  {{ realtimeData?.U2 || 0 }} 
                  <span class="value-unit">V</span>
                </div>
              </div>
          ...
          <div class="data-table">
            ...
            <div class="detail-values">
              <div class="value-row">
                <span class="phase-label">L1</span>
                <div class="phase-value" :class="getCurrentClass(realtimeData?.I1)">
                  {{ realtimeData?.I1 || 0 }} 
              ...
              <div class="value-row">
                <span class="phase-label">L2</span>
                <div class="phase-value" :class="getCurrentClass(realtimeData?.I2)">
                  {{ realtimeData?.I2 || 0 }} 
                  <span class="value-unit">A</span>
                </div>
              </div>
              <div class="value-row">
                <span class="phase-label">L3</span>
                <div class="phase-value" :class="getCurrentClass(realtimeData?.I3)">
                  {{ realtimeData?.I3 || 0 }} 
                  <span class="value-unit">A</span>
                </div>
              </div>
