      ...
      <table class="table-auto w-full dark:text-white">
        ...
        <thead class="text-xs uppercase text-gray-400 bg-gray-50 dark:bg-gray-300 dark:text-gray-200 dark:bg-opacity-50 rounded-sm">
          <tr>
            ...
            <th class="p-2">
              <div class="font-bold text-center">{{ t('meter.Table.th_min') }}</div>
            </th>
            <th class="p-2">
              <div class="font-bold text-center">{{ t('meter.Table.th_max') }}</div>
            </th>
            <th class="p-2">
              <div class="font-bold text-center">{{ t('meter.Table.th_minTime') }}</div>
            </th>
            <th class="p-2">
...
setup(props){
  ...
  watchEffect(() => {
    ...
    //console.log('meterTable2', datlist.value);
  });
