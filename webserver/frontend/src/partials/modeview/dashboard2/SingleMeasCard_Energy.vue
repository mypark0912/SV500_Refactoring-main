      ...
      <div class="summary-grid">
        ...
        <div class="summary-item today">
          ...
          <div class="summary-content">
            ...
            <div class="summary-value">
              <template v-if="energyData && energyData.length > 0">
                61 <span class="summary-unit">kwh</span>
              </template>
              <template v-else>
                {{ parseFloat(consumptionData.daily).toFixed(2) }} <span class="summary-unit">kwh</span>
              </template>
            </div>
        ...
        <div class="summary-item month">
          ...
          <div class="summary-content">
            ...
            <div class="summary-value">
              <template v-if="energyData && energyData.length > 0">
                {{ energyData[0].data[1].value.toFixed(2) }} <span class="summary-unit">{{ energyData[0].data[1].unit }}</span>
              </template>
              <template v-else>
                {{ parseFloat(consumptionData.monthly).toFixed(2) }} <span class="summary-unit">kwh</span>
              </template>
            </div>
            <div class="summary-compare">
